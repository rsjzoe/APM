...
public interface CategoryODAParentRepository {
    ...
    CategoryODAParentOutput findById(Long id) throws CategoryODAParentNotFoundException;

    CategoryODAParentOutput deleteById(Long id) throws CategoryODAParentNotFoundException;
